...
public final class AquaLive {
    ...
    private AquaLive(final Platform platform, final Settings settings, final Messages messages) {
        this.platform = platform;
        this.settings = settings;
        this.messages = messages;

        final Announcer broadcast = new Announcer(platform, settings, messages);
    ...
    public static AquaLive start(final Platform platform) throws IOException {
        ...
        final AquaLive core = new AquaLive(platform, settings, messages);
